...
- `priority` is **not** the project's top/urgent level (`Highest`, or `P1` under the `P`-scheme). A non-urgent or unset priority passes — Jira priority is coarse metadata here, like gh-issue's optional priority label.
