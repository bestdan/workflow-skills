...
- **GitHub mode, with requests** → `cat "<this skill dir>/review_prompt.md" "<REQUESTS>" > "<INPUT>"; gh pr diff <n> --repo <owner>/<name> >> "<INPUT>"; cat "<INPUT>" | codex exec --sandbox read-only --model "gpt-5.6-terra" "<POINTER>"`
- **GitHub mode, no requests** → drop the `"<REQUESTS>"` argument: `cat "<this skill dir>/review_prompt.md" > "<INPUT>"; gh pr diff <n> --repo <owner>/<name> >> "<INPUT>"; cat "<INPUT>" | codex exec --sandbox read-only --model "gpt-5.6-terra" "<POINTER>"` (use whatever read-only/sandbox flag your codex version supports).
