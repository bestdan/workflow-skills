...
- **exit 1 (`absent`)** → the branch is checked out nowhere, so this tree is on something else (the `head=` field names what). Stop and offer to check it out here, or to make a worktree for it. Don't review the tree you happen to be in.
