...
# Step 1 — Rename the task skill (source of truth)
...
- This PR is intentionally the **first** because it defines the new vocabulary that later PRs reference. Other files still say `todo` after this PR — that is expected and resolved in Steps 2–6.
...
- Add a **## Legacy migration** section (canonical one-time-prompt procedure, referenced by Steps 2 & 5):
