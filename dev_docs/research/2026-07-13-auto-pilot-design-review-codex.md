...
The code needs extensive comments merely to preserve that topology ([spawn-orchestrator.sh](../../scripts/spawn-orchestrator.sh#L1093)). The post-mortem shows two independent PRs landing on the wrong side without conflicts ([review feedback](2026-07-12-auto-pilot-developer-review-feedback.md#L62)).
...
- settled-state fixtures missed the dangerous window between writes ([review feedback](2026-07-12-auto-pilot-developer-review-feedback.md#L13)).
