...
related:
  ...
  - ../decisions/2026-07-09-autopilot-dry-run.md
  - ../decisions/2026-07-10-autopilot-detached-run-1-findings.md
  - ../decisions/2026-07-12-auto-pilot-developer-review-feedback.md
  - ./2026-07-12-auto-pilot-inversion.md
...
2. **The feedback root** — the improvement stream starts at
   [`2026-07-09-autopilot-dry-run.md`](../decisions/2026-07-09-autopilot-dry-run.md) (attended, Jul 9, 5 findings)
   and [`2026-07-10-autopilot-detached-run-1-findings.md`](../decisions/2026-07-10-autopilot-detached-run-1-findings.md)
...
| Jul 9      | **Attended dry-run** (Step-7 spawn skipped)                                                                                                                                                                                                                     | `2026-07-09-autopilot-dry-run.md`                                                                                                 | `--until` guard, `--handler` override, and **PRE-484: build the spawn + jail helper** (finding #4) |
...
| Jul 10     | **Detached run #1** (linear-fastpath-p2): 6/6 handed off, but 3 fatal spawn bugs hand-patched                                                                                                                                                                   | `2026-07-10-autopilot-detached-run-1-findings.md` (18 findings)                                                                   | the hardening plan                                                                                 |
...
| Jul 12     | Co-review of #188–#191: 3 of 4 PRs defective while green                                                                                                                                                                                                        | [`2026-07-12-auto-pilot-developer-review-feedback.md`](../decisions/2026-07-12-auto-pilot-developer-review-feedback.md) (PR #192) | tasks 22–29; the inversion question                                                                |
| Jul 12     | Attended fixes: tasks 20, 23–27; supervisor ledger untracked                                                                                                                                                                                                    | PRs #193–#200                                                                                                                     | —                                                                                                  |
| Jul 12–13  | **The pivot**: inversion v1 ("one root cause, rewrite") → adversarially falsified → v2 scoped                                                                                                                                                                   | [`2026-07-12-auto-pilot-inversion.md`](./2026-07-12-auto-pilot-inversion.md) + 2 codex reviews (PR #201)                          | Stage 0–3 plan; complexity tracker                                                                 |
...
flowchart TD
    ...
    subgraph RUNS["THE RUNS — the real-run feedback"]
        DRY["attended dry-run, Jul 9<br/>2026-07-09-autopilot-dry-run.md, 5 findings"]
        JAIL["spawn + jail helper, PRE-484, Jul 10<br/>spawn-orchestrator.sh: seatbelt + egress + launchd"]
        RUN1["detached run 1, Jul 10<br/>6/6 handed off, 3 fatal spawn bugs hand-patched<br/>2026-07-10-autopilot-detached-run-1-findings.md, 18 findings"]
    ...
    subgraph REVIEW["REVIEW LAYER — fixes reviewed, not run"]
        FEED["co-review of 188–191: 3 of 4 defective while green<br/>2026-07-12-auto-pilot-developer-review-feedback.md, PR 192<br/>lesson: harness diverges from production<br/>at exactly the invariant boundary"]
    end
...
2. [`2026-07-09-autopilot-dry-run.md`](../decisions/2026-07-09-autopilot-dry-run.md) — attended run; the seams.
3. [`2026-07-10-autopilot-detached-run-1-findings.md`](../decisions/2026-07-10-autopilot-detached-run-1-findings.md)
...
5. [`2026-07-12-auto-pilot-developer-review-feedback.md`](../decisions/2026-07-12-auto-pilot-developer-review-feedback.md)
   — why green suites lied; the class-level lessons.
6. [`2026-07-12-auto-pilot-inversion.md`](./2026-07-12-auto-pilot-inversion.md) (+ the two
