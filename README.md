...
| **`/promote-todos`** | `/promote-todos [dry-run \| apply]`                                                                                  | Score `new` todos against the confidence check and promote them to `ready` or `needs_refinement`.                                                                                                                                                                                            |
| **`/claim-todo`**    | `/claim-todo [issue id]`                                                                                             | Find a todo small enough to finish in this session, claim it, branch, code, and open a PR — dispatches to the configured handler (Linear today; file-based defers to `/process-todo --local`).                                                                                               |
