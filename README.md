...
| [**`/archive-tasks`**](commands/archive-tasks.md)             | `/archive-tasks [--older-than <N>d] [--issues <refs>] [dry-run]`          | Retire terminal-state work past an age threshold. A sweep refuses to mutate without a threshold.                                 |
