...
| `commands/handlers/linear-archive.md` | **(new consumer)** sweep across **all** configured projects instead of the single `default_project` (project narrowing deferred)                                                                |
| `commands/push-plan.md`               | **(new consumer)** with multiple projects, prompt which one to push the plan into instead of using the lone pin                                                                                 |
